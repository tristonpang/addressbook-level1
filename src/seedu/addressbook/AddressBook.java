...
public class AddressBook {
    ...
    private static final String COMMAND_SORT_DESC = "Displays all persons as an alphabetically ordered list";
    private static final String COMMAND_SORT_EXAMPLE = COMMAND_SORT_WORD;

    private static final String COMMAND_EDIT_WORD = "edit";
    private static final String COMMAND_EDIT_DESC = "Updates the details of the person identified by the index number "
            + "used in the last find/list/sort call";
    ...
    private static String executeListAllPersonsSorted() {
        ...
        sortPersonsListByAlphabeticalOrder(toBeDisplayed);
        showToUser(toBeDisplayed);
        return getMessageForPersonsDisplayedSummary(toBeDisplayed);
    }

    /**
     * Sorts (in-place) a specified list of persons by alphabetical order of their names.
     *
     * @param personsList Specified list of persons
     */
    private static void sortPersonsListByAlphabeticalOrder(ArrayList<HashMap<PersonProperty, String>> personsList) {
    ...
    private static boolean isEditPersonArgsValid(String commandArgs) {
        String[] splitArgs = splitTargetIndexAndPersonData(commandArgs);
        String targetIndexString = splitArgs[0];
        String personData = splitArgs[1];
        try {
            ...
            return isPersonDataExtractableFrom(personData);
        }

    }

    private static String[] splitTargetIndexAndPersonData(String commandArgs) {
